...
pheatmap(mat_top, scale = "row", show_rownames = TRUE, show_colnames = FALSE,
...
```{r}
deconv = compute.deconvolution(expr_matrix, normalized = F, credentials.mail = "augustine.blancboekholt@etu.toulouse-inp.fr", credentials.token = "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", file_name = "Deconv_scie-panc") 
```
