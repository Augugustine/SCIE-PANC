...
pheatmap(mat_top, scale = "row", show_rownames = FALSE, show_colnames = FALSE, annotation_col = clinical, clustering_method = "complete", main="Heatmap of PDAC patients on top 300 genes")
```
...
pca_data$Sex <- clinical$Gender             # Add Sex information
...
ggplot(pca_data, aes(x = PC1, y = PC2, color = Sex, shape = Alive)) +
    geom_point(size = 3) +
    labs(title = "PCA Bulk RNA-seq Data PDAC",
